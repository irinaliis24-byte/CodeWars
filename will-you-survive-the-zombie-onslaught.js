...
function zombieShootout (zombies, range, ammo) {
	for (let i = zombies; i >= 0; i--) {
        if (range === 0 && i > 0) {
            return "You shot " + (zombies - i) + " zombies before being eaten: overwhelmed.";
        } else if (ammo === 0 && i > 0) {
            return "You shot " + (zombies - i) + " zombies before being eaten: ran out of ammo.";
        } else if (i === 0) {
